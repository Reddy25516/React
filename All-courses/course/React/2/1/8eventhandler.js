...
//hi will be printed in the console 

'======================================================'

'to chnage the state for the above code we have to use the arrow function for it'
...
// when ever you click on the button 
// then the message will change to Hello 
'this cannot be done without the arrow function , will get an error if we does so'

//there are other two ways which we used in the below

'--------------------------'

// this also works see the onclick function 
...
// using arrow function for the above thing 
...
// this is also an another approach for the above code 
...
// another approach is to use the arrow function for it
