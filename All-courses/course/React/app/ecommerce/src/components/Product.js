        ...
        <div className='col-10 product d-flex'>
           ...
           <div className='left col-6  row '>
                <div className='col-2 side-images'>
                    <img className="img-fluid small-img" src={post.images[0]}></img>
                    <img className="img-fluid small-img" src={post.images[1]}></img>
                    <img className="img-fluid small-img" src={post.images[2]}></img>
                    <img className="img-fluid small-img" src={post.images[3]}></img>
                </div>
                <div className='img1 col-8'>
                    <img className="img-fluid" id="large-image" src={post.thumbnail}></img>
                </div>
