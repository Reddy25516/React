  ...
  return (
    <userContext.Provider value={
      [posts, addToCart, jsonData, setPosts, load_rating,
       cartCount, setCartCount, addToWishList,setWishCount,wishCount,filterAll,setIsSigned,isSigned,myAccount,setMyAccount,setLocal]}>
      <>
        <Header jsonData={jsonData} setPosts={setPosts} cartCount={cartCount} wishCount={wishCount} posts={posts} 
        filterAll={filterAll} isSigned={isSigned} setIsSigned={setIsSigned} myAccount={myAccount} setMyAccount={setMyAccount}/>
