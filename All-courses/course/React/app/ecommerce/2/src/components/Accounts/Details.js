...
const Details = () => {
  const [imageUrl,setImageUrl,name,setName,phone,setPhone,myAccount,setMyAccount] = useContext(accountContext);
  ...
  return (
    <div className='details d-flex'>
      <div className='col-4 image'>
        <img id='img' src={imageUrl} className='img1'/>
        <label for="imgInput" class="btn">Set Photo</label>
