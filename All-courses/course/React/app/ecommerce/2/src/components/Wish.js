...
const Wish = () => {
    const [posts, addToCart, jsonData, setPosts, load_rating,
        cartCount, setCartCount, addToWishList,setWishCount,wishCount]= useContext(userContext);
           ...
           <table className='col-12 border' >
            ...
            <tr className='border'>
                ...
                <td className='btns text-center'>
                    <button type='button' className='border btn2' onClick={addToWishList} name={post.id}> Remove from wishlist </button>
